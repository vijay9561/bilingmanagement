          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
             <!-- <div class="brand-logo">
                <img src="<?php echo site_url(); ?>support_assets/images/vjm_logos.png">
              </div>-->
              <h3>Inventory Management Login</h3>
              <form class="pt-3" method="post" id="loging_submit">
                ...
                <div class="form-group">
                    <input type="text" maxlength="100" class="form-control form-control-lg" id="username" name="username" placeholder="Username or Mobile No">
                </div>
                <div class="form-group">
