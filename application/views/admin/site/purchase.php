          ...
          <div class="row">
           <div class="col-md-12">
            ...
            <div class="card-header">
              <i class="fa fa-shopping-bag"></i> Purchase New Product
            </div>
              <div class="card-body">
               <div class="alert alert-danger" id="error_message_change" style="display:none;"></div> 
               <form method="post" id="purchase_master_forms">
                   <div class="row">  
                ...
                <input type="text" class="form-control" value="" name="qty" id="qty" placeholder="Quantity">
                  ...
                  <div class="form-group col-md-2">    
                      <br>
                  <button type="submit" id="purchase__button" class="btn btn-gradient-primary mr-2">Add Item</button>
                  </div>
                  </div>
                  </form>
...
<table class="table table-bordered">
                        ...
                        <th>Action</th>
                          ...
                          <?php $i=1; foreach($datas as $row){ ?>
                             ...
                             <td><a href="#" onclick="return delete_purchase_masters(<?php echo $row->id ?>)" title="Delete" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a></td>
                              </tr>    
                          <?php } ?>    
                          </tbody>   
                      </table> 
                  <br>
                      <form method="post" id="finally_purchase_form">  
                          <div class="row">
                      <div class="col-md-5">
                          <input type="text" id="vendor_name" class="form-control" placeholder="Purchase Vendor Name" name="vendor_name" />  
                     ...
                     <div class="form-group col-md-2">    
                         <button type="button" id="purchase__button" onclick="purchase_product()" class="btn btn-gradient-primary mr-2">Submit</button>
                  </div> 
                            </div>  
                      </form>
              </div>
            ...
            <?php }elseif(isset($_GET['pid'])){
                ...
                $rows=$this->db->query("select *from Purchase_Master where id='$id'")->row();
                 $current=$this->db->query("select *from Users where id='".$this->session->userdata('ADMIN_ID')."'")->row();
                   ...
                   $items=$this->db->query("select *from Purchase_Item where pid='$id'")->result(); 
...
<div class="col-md-3" style="text-align:center;">
    ...
    <a href="<?php echo site_url(); ?>purchase_master" class="btn btn-danger btn-sm"> Back</a></div>
  <div class="row">
...
<br />
            ...
            <?php }else{ ?>  
                <div class="card">
            <div class="card-header">
                <i class="mdi mdi-table-large"></i> GST Master List <a href="<?php echo site_url() ?>purchase_master?add=new" class="btn btn-gradient-info btn-sm"> Add New <i class="fa fa-plus"></i></a>
            </div>
              <div class="card-body">
                 ...
                 <?php $this->session->unset_userdata('success'); } ?>
                  <div class="table-responsive">
                      <table class="table table-bordered" id="purchase_all_list">
                          <thead>
                              <tr>
                        <th>Sr.No</th>
                        <th>Order ID</th>
